...
public class CustomMonthTwoView extends MonthView {
...
//    private float mSchemeBaseLine;
    public CustomMonthTwoView(Context context) {
        super(context);
...
//        mSchemeBasicPaint.setMaskFilter(new BlurMaskFilter(28, BlurMaskFilter.Blur.SOLID));
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme) {
        ...
        canvas.drawCircle(cx, cy - SizeUtils.dp2px(5), mRadius, mSelectedPaint);
        //圆角矩形
//        RectF r2 = new RectF();
//        r2.left = x + mPadding;
