...
public class MuGuFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void playSound() {
        try {
            if (mediaPlayer == null) {
                ...
                mediaPlayer = MediaPlayer.create(getActivity(), R.raw.qiaogu_score);
                //播放完成触发此事件
        ...
        RxHttp.postJson(Comments.HAODE_SAVE)
                ...
                .subscribe(model -> {
                    ...
                    if (successHintPopup == null) {
                        successHintPopup = new SuccessHintPopup(getActivity(), "完成暮鼓", "确定",new SuccessHintPopup.onClickDone() {
                            @Override
