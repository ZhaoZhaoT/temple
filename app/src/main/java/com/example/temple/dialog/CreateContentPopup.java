 ...
 * 创建 视频 相册 文章 弹窗
 */
public class CreateContentPopup extends CenterPopupView implements View.OnClickListener {
    ...
    public CreateContentPopup(@NonNull @NotNull Context context, CreateContentPopup.onClickDone onClickDone) {
        super(context);
    ...
    protected int getImplLayoutId() {
        return R.layout.dialog_creat_content;
    }
