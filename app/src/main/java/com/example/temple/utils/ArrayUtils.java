 ...
 * before the first one that match the target element front to back</li>
 * <li>{@link #getNext(Object[], Object, Object, boolean)} get next element of the target element,
 * after the first one that match the target element front to back</li>
...
public class ArrayUtils {
     ...
     * isCircle is true, else return defaultValue</li>
     * </ul>
     *
     * @param <V>
     * @param sourceArray
     ...
     * if isCircle is true, else return defaultValue</li>
     * </ul>
     *
     * @param <V>
     * @param sourceArray
     ...
     * @return
     */
    public static ArrayList<String> splitArrayList(String... value) {
        if (value == null || value.length == 0) {
            return null;
        }
     ...
     * @return
     */
    public static String[] splitArrays(List<String> value) {
        if (value == null || value.isEmpty()) {
            return null;
        }
        String[] arary = new String[value.size()];
