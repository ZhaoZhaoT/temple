...
import com.example.temple.fragment.MuGuFragment;
...
public class MuGuActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    private final String[] mTitles = {"暮鼓", "排行"};
    ...
    protected void initView() {
        ...
        fragments.add(new MuGuFragment());
        fragments.add(new PaihangFragment("THREE"));
