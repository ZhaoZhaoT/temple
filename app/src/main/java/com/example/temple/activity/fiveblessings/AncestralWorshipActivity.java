 ...
 * 宗亲祭祀
 */
public class AncestralWorshipActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_ancestral_worship;
    }
...
//
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.iv_left) {
            ...
            startActivity(new Intent(AncestralWorshipActivity.this, ScheduleActivity.class).putExtra("from", 1));

        } else if (v.getId() == R.id.relat_memorabilia) {//大事记
            startActivity(new Intent(AncestralWorshipActivity.this, SurnameMemorabiliaActivity.class).putExtra("from", 1));

        } else if (v.getId() == R.id.tv_my_publishing) {
            startActivity(new Intent(AncestralWorshipActivity.this, SurnameMemorabiliaActivity.class).putExtra("index", 1).putExtra("from", 1));
