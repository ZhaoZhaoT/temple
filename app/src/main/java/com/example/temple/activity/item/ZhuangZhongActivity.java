...
import com.example.temple.fragment.PaihangFragment;
import com.example.temple.fragment.ZhuangZhongFragment;
...
public class ZhuangZhongActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    private final String[] mTitles = {"晨钟", "排行"};
    ...
    protected void initView() {
        ...
        fragments.add(new ZhuangZhongFragment());
        fragments.add(new PaihangFragment("TWO"));
