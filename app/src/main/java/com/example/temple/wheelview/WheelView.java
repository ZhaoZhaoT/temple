...
import com.example.temple.wheelview.listener.LoopViewGestureListener;
import com.example.temple.wheelview.listener.OnItemSelectedListener;
import com.example.temple.wheelview.timer.InertiaTimerTask;
import com.example.temple.wheelview.timer.MessageHandler;
import com.example.temple.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private static final float SCALE_CONTENT = 1;//非中间文字则用此控制高度，压扁形成3d错觉
    ...
    public final void setCurrentItem(int currentItem, int itemsVisible) {
...
//            }
            endX = measuredWidth;
            //画圆角矩形
//            RectF oval3 = new RectF((startX + dp2px(context, 10)), firstLineY, (endX - dp2px(context, 10)), secondLineY);// 设置个新的长方形
//            canvas.drawRoundRect(oval3, 20, 15, paintIndicator);//第二个参数是x半径，第三个参数是y半径
            //画分割线
            ...
            //画圆角矩形
            RectF oval3 = new RectF((0 + dp2px(context, 10)), firstLineY, (measuredWidth - dp2px(context, 10)), secondLineY);// 设置个新的长方形
            canvas.drawRoundRect(oval3, 20, 15, paintIndicator);//第二个参数是x半径，第三个参数是y半径
            //画分割线
