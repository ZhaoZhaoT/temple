package com.example.temple.wheelview;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_year.setCurrentItem(year - startYear, itemsVisible);// 初始化时显示的数据
        ...
        if (leapMonth != 0 && (month > leapMonth - 1 || isLeap)) { //选中月是闰月或大于闰月
            wv_month.setCurrentItem(month + 1, itemsVisible);
        } else {
            wv_month.setCurrentItem(month, itemsVisible);
        }
        ...
        wv_day.setLabel("");
        wv_day.setCurrentItem(day - 1, itemsVisible);
        wv_day.setGravity(gravity);

        wv_hours = (WheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h, itemsVisible);
        ...
        wv_minutes.setCurrentItem(m, itemsVisible);
        ...
        wv_seconds.setCurrentItem(m, itemsVisible);
        ...
        wv_year.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (ChinaDate.leapMonth(year_num) != 0 && wv_month.getCurrentItem() > ChinaDate.leapMonth(year_num) - 1) {
                    wv_month.setCurrentItem(wv_month.getCurrentItem() + 1, itemsVisible);
                } else {
                    wv_month.setCurrentItem(wv_month.getCurrentItem(), itemsVisible);
                }
                ...
                if (wv_day.getCurrentItem() > maxItem - 1) {
                    wv_day.setCurrentItem(maxItem - 1, itemsVisible);
                }
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        if (startYear == endYear) {//开始年等于终止年
            ...
            wv_month.setCurrentItem(month + 1 - startMonth, itemsVisible);
        ...
        if (startYear == endYear && startMonth == endMonth) {
            ...
            wv_day.setCurrentItem(day - startDay, itemsVisible);
        ...
        wv_seconds.setCurrentItem(s, itemsVisible);
        wv_seconds.setGravity(gravity);
            ...
            public void onItemSelected(int index) {
                ...
                if (startYear == endYear) {
                    ...
                    if (currentMonthItem > wv_month.getAdapter().getItemsCount() - 1) {
                        ...
                        wv_month.setCurrentItem(currentMonthItem, itemsVisible);
                    }
...
//                maxItem = endD;
        ...
        if (currentItem > wv_day.getAdapter().getItemsCount() - 1) {
            ...
            wv_day.setCurrentItem(currentItem, itemsVisible);
        }
    }
